...
.def(::boost::python::init<dart::dynamics::Skeleton *, double>((::boost::python::arg("_skel"), ::boost::python::arg("_fps"))))
...
.def("saveFile", static_cast<bool (dart::utils::FileInfoDof::*)(const char *, std::size_t, std::size_t, double)>(&dart::utils::FileInfoDof::saveFile), (::boost::python::arg("_fileName"), ::boost::python::arg("_start"), ::boost::python::arg("_end"), ::boost::python::arg("_sampleRate")))
