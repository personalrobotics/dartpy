...
.def(::boost::python::init<dart::dynamics::BodyNode *, dart::dynamics::Linkage::Criteria::ExpansionPolicy, bool>((::boost::python::arg("_target"), ::boost::python::arg("_policy"), ::boost::python::arg("_chain"))))
