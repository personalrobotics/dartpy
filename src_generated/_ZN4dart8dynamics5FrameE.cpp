...
.def("getChildEntities", static_cast<const std::set<dart::dynamics::Entity *> &(dart::dynamics::Frame::*)()>(&dart::dynamics::Frame::getChildEntities), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
...
.def("getChildFrames", static_cast<const std::set<dart::dynamics::Frame *> &(dart::dynamics::Frame::*)()>(&dart::dynamics::Frame::getChildFrames), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
...
.def("draw", static_cast<void (dart::dynamics::Frame::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool, int) const>(&dart::dynamics::Frame::draw), (::boost::python::arg("_ri"), ::boost::python::arg("_color"), ::boost::python::arg("_useDefaultColor"), ::boost::python::arg("_depth")))
