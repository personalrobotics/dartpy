...
::boost::python::class_<dart::dynamics::BodyNode, ::boost::noncopyable, dart::dynamics::BodyNodePtr, ::boost::python::bases<dart::common::AddonManager, dart::dynamics::SpecializedNodeManagerForBodyNode<dart::dynamics::EndEffector>, dart::dynamics::SkeletonRefCountingBase, dart::dynamics::TemplatedJacobianNode<dart::dynamics::BodyNode> > >("BodyNode", boost::python::no_init)
