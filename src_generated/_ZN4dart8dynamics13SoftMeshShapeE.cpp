...
.def("draw", static_cast<void (dart::dynamics::SoftMeshShape::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool) const>(&dart::dynamics::SoftMeshShape::draw), (::boost::python::arg("_ri"), ::boost::python::arg("_col"), ::boost::python::arg("_default")))
;
}
