...
.def("copy", static_cast<void (dart::dynamics::SimpleFrame::*)(const dart::dynamics::Frame &, dart::dynamics::Frame *, bool)>(&dart::dynamics::SimpleFrame::copy), (::boost::python::arg("_otherFrame"), ::boost::python::arg("_refFrame"), ::boost::python::arg("_copyProperties")))
.def("copy", static_cast<void (dart::dynamics::SimpleFrame::*)(const dart::dynamics::Frame *, dart::dynamics::Frame *, bool)>(&dart::dynamics::SimpleFrame::copy), (::boost::python::arg("_otherFrame"), ::boost::python::arg("_refFrame"), ::boost::python::arg("_copyProperties")))
