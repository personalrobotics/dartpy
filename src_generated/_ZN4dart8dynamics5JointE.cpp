...
::boost::python::class_<dart::dynamics::Joint, ::boost::noncopyable, dart::dynamics::JointPtr, ::boost::python::bases<dart::common::Subject, dart::common::AddonManager > >("Joint", boost::python::no_init)
...
.def("copy", static_cast<void (dart::dynamics::Joint::*)(const dart::dynamics::Joint *)>(&dart::dynamics::Joint::copy), (::boost::python::arg("_otherJoint")))
.def("setName", static_cast<const std::string &(dart::dynamics::Joint::*)(const std::string &, bool)>(&dart::dynamics::Joint::setName), ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("_name"), ::boost::python::arg("_renameDofs")))
...
.def("setDofName", static_cast<const std::string &(dart::dynamics::Joint::*)(std::size_t, const std::string &, bool)>(&dart::dynamics::Joint::setDofName), ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("_index"), ::boost::python::arg("_name"), ::boost::python::arg("_preserveName")))
...
.def("checkSanity", static_cast<bool (dart::dynamics::Joint::*)(bool) const>(&dart::dynamics::Joint::checkSanity), (::boost::python::arg("_printWarnings")))
