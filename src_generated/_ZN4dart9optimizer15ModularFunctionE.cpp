...
.def(::boost::python::init<const std::string &>((::boost::python::arg("_name") = "modular_function")))
...
.def("clearCostFunction", static_cast<void (dart::optimizer::ModularFunction::*)(bool)>(&dart::optimizer::ModularFunction::clearCostFunction), (::boost::python::arg("_printWarning")))
