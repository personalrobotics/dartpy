...
.def("setAxisOrder", static_cast<void (dart::dynamics::EulerJoint::*)(dart::dynamics::EulerJoint::AxisOrder, bool)>(&dart::dynamics::EulerJoint::setAxisOrder), (::boost::python::arg("_order"), ::boost::python::arg("_renameDofs")))
