...
.def(::boost::python::init<dart::simulation::WorldPtr, dart::dynamics::SkeletonPtr, const std::vector<std::size_t> &, const Eigen::VectorXd &, double>((::boost::python::arg("world"), ::boost::python::arg("robot"), ::boost::python::arg("dofs"), ::boost::python::arg("root"), ::boost::python::arg("stepSize"))))
.def(::boost::python::init<dart::simulation::WorldPtr, dart::dynamics::SkeletonPtr, const std::vector<std::size_t> &, const std::vector<Eigen::VectorXd> &, double>((::boost::python::arg("world"), ::boost::python::arg("robot"), ::boost::python::arg("dofs"), ::boost::python::arg("roots"), ::boost::python::arg("stepSize"))))
...
.def("tracePath", static_cast<void (dart::planning::RRT::*)(int, std::list<Eigen::VectorXd> &, bool)>(&dart::planning::RRT::tracePath), (::boost::python::arg("node"), ::boost::python::arg("path"), ::boost::python::arg("reverse")))
