...
::boost::python::class_<dart::dynamics::MultiDofJoint<2>, ::boost::noncopyable, dart::dynamics::MultiDofJoint<2> *, ::boost::python::bases<dart::dynamics::Joint, dart::common::SpecializedAddonManager<dart::dynamics::detail::MultiDofJointAddon<2> > > >("TwoDofJoint", boost::python::no_init)
...
.def("getMultiDofJointAddon", static_cast<dart::dynamics::MultiDofJoint<2>::Addon *(dart::dynamics::MultiDofJoint<2>::*)()>(&dart::dynamics::MultiDofJoint<2>::getMultiDofJointAddon), ::boost::python::return_value_policy<boost::python::reference_existing_object >())
