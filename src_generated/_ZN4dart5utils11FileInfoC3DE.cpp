...
.def("saveFile", static_cast<bool (dart::utils::FileInfoC3D::*)(const char *, int, int, double)>(&dart::utils::FileInfoC3D::saveFile), (::boost::python::arg(""), ::boost::python::arg("_start"), ::boost::python::arg("_end"), ::boost::python::arg("_sampleRate") = 1.000000e+00))
;
}
