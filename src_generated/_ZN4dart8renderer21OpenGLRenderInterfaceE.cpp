...
.def("draw", static_cast<void (dart::renderer::OpenGLRenderInterface::*)(dart::dynamics::Skeleton *, bool, bool)>(&dart::renderer::OpenGLRenderInterface::draw), (::boost::python::arg("_skel"), ::boost::python::arg("_vizCol"), ::boost::python::arg("_colMesh")))
.def("draw", static_cast<void (dart::renderer::OpenGLRenderInterface::*)(dart::dynamics::BodyNode *, bool, bool)>(&dart::renderer::OpenGLRenderInterface::draw), (::boost::python::arg("_node"), ::boost::python::arg("_vizCol"), ::boost::python::arg("_colMesh")))
...
.def("saveToImage", static_cast<void (dart::renderer::OpenGLRenderInterface::*)(const char *, dart::renderer::DecoBufferType)>(&dart::renderer::OpenGLRenderInterface::saveToImage), (::boost::python::arg("_filename"), ::boost::python::arg("_buffType")))
;
}
