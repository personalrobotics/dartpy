...
.def(::boost::python::init<const std::string &>((::boost::python::arg("_name") = "world")))
...
.def("checkCollision", static_cast<bool (dart::simulation::World::*)(bool)>(&dart::simulation::World::checkCollision), (::boost::python::arg("_checkAllCollisions")))
.def("reset", static_cast<void (dart::simulation::World::*)()>(&dart::simulation::World::reset))
.def("step", static_cast<void (dart::simulation::World::*)(bool)>(&dart::simulation::World::step), (::boost::python::arg("_resetCommand")))
