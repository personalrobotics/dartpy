...
.def("setErrorLengthClamp", static_cast<void (dart::dynamics::InverseKinematics::ErrorMethod::*)(double)>(&dart::dynamics::InverseKinematics::ErrorMethod::setErrorLengthClamp), (::boost::python::arg("_clampSize")))
