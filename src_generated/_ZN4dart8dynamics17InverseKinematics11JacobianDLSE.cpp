...
.def("setDampingCoefficient", static_cast<void (dart::dynamics::InverseKinematics::JacobianDLS::*)(double)>(&dart::dynamics::InverseKinematics::JacobianDLS::setDampingCoefficient), (::boost::python::arg("_damping") = 5.000000e-02))
