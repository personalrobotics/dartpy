...
.def("addCollisionSkeletonNode", static_cast<void (dart::collision::CollisionDetector::*)(dart::dynamics::BodyNode *, bool)>(&dart::collision::CollisionDetector::addCollisionSkeletonNode), (::boost::python::arg("_bodyNode"), ::boost::python::arg("_isRecursive")))
.def("removeCollisionSkeletonNode", static_cast<void (dart::collision::CollisionDetector::*)(dart::dynamics::BodyNode *, bool)>(&dart::collision::CollisionDetector::removeCollisionSkeletonNode), (::boost::python::arg("_bodyNode"), ::boost::python::arg("_isRecursive")))
