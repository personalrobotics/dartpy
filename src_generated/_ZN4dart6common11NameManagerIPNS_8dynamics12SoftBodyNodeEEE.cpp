...
.def("removeEntries", static_cast<void (dart::common::NameManager<dart::dynamics::SoftBodyNode *>::*)(const std::string &, dart::dynamics::SoftBodyNode *const &)>(&dart::common::NameManager<dart::dynamics::SoftBodyNode *>::removeEntries), (::boost::python::arg("_name"), ::boost::python::arg("_obj")))
