...
.def("getSingleDofJointAddon", static_cast<dart::dynamics::SingleDofJoint::Addon *(dart::dynamics::SingleDofJoint::*)()>(&dart::dynamics::SingleDofJoint::getSingleDofJointAddon), ::boost::python::return_value_policy<boost::python::reference_existing_object >())
...
.def("setDofName", static_cast<const std::string &(dart::dynamics::SingleDofJoint::*)(std::size_t, const std::string &, bool)>(&dart::dynamics::SingleDofJoint::setDofName), ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("_index"), ::boost::python::arg("_name"), ::boost::python::arg("_preserveName")))
