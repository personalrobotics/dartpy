...
.def("verifyMoment", static_cast<bool (*)(const Eigen::Matrix3d &, bool, double)>(&dart::dynamics::Inertia::verifyMoment), (::boost::python::arg("_moment"), ::boost::python::arg("_printWarnings") = true, ::boost::python::arg("_tolerance") = 1.000000e-08))
.def("verifySpatialTensor", static_cast<bool (*)(const Eigen::Matrix6d &, bool, double)>(&dart::dynamics::Inertia::verifySpatialTensor), (::boost::python::arg("_spatial"), ::boost::python::arg("_printWarnings") = true, ::boost::python::arg("_tolerance") = 1.000000e-08))
.def("verify", static_cast<bool (dart::dynamics::Inertia::*)(bool, double) const>(&dart::dynamics::Inertia::verify), (::boost::python::arg("_printWarnings") = true, ::boost::python::arg("_tolerance") = 1.000000e-08))
