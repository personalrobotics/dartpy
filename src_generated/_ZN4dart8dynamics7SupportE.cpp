...
.def("getGeometry", static_cast<const dart::math::SupportGeometry &(dart::dynamics::Support::*)() const>(&dart::dynamics::Support::getGeometry), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
.def("setActive", static_cast<void (dart::dynamics::Support::*)(bool)>(&dart::dynamics::Support::setActive), (::boost::python::arg("_supporting")))
