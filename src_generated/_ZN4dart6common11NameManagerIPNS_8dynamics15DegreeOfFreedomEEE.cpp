...
.def("removeEntries", static_cast<void (dart::common::NameManager<dart::dynamics::DegreeOfFreedom *>::*)(const std::string &, dart::dynamics::DegreeOfFreedom *const &)>(&dart::common::NameManager<dart::dynamics::DegreeOfFreedom *>::removeEntries), (::boost::python::arg("_name"), ::boost::python::arg("_obj")))
