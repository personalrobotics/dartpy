...
.def("drawCollisionSkeletonNode", static_cast<void (dart::collision::FCLMeshCollisionNode::*)(bool)>(&dart::collision::FCLMeshCollisionNode::drawCollisionSkeletonNode), (::boost::python::arg("_bTrans") = true))
