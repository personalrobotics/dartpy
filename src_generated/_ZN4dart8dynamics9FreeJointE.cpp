...
.def("setTransform", static_cast<void (*)(dart::dynamics::Skeleton *, const Eigen::Isometry3d &, const dart::dynamics::Frame *, bool)>(&dart::dynamics::FreeJoint::setTransform), (::boost::python::arg("skeleton"), ::boost::python::arg("tf"), ::boost::python::arg("withRespectTo"), ::boost::python::arg("applyToAllRootBodies")))
