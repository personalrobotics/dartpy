...
.def("draw", static_cast<void (dart::dynamics::Entity::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool, int) const>(&dart::dynamics::Entity::draw), (::boost::python::arg("_ri"), ::boost::python::arg("_color"), ::boost::python::arg("_useDefaultColor"), ::boost::python::arg("_depth")))
.def("getParentFrame", static_cast<dart::dynamics::Frame *(dart::dynamics::Entity::*)()>(&dart::dynamics::Entity::getParentFrame), ::boost::python::return_value_policy<boost::python::reference_existing_object >())
