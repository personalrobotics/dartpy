...
.def(::boost::python::init<std::size_t>((::boost::python::arg("_dim"))))
...
.def("getSeed", static_cast<Eigen::VectorXd &(dart::optimizer::Problem::*)(std::size_t)>(&dart::optimizer::Problem::getSeed), ::boost::python::return_value_policy<boost::python::copy_non_const_reference >(), (::boost::python::arg("_index")))
...
.def("getSeeds", static_cast<std::vector<Eigen::VectorXd> &(dart::optimizer::Problem::*)()>(&dart::optimizer::Problem::getSeeds), ::boost::python::return_value_policy<boost::python::copy_non_const_reference >())
