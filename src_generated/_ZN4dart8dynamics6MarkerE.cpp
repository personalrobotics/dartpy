...
.def(::boost::python::init<const std::string &, const Eigen::Vector3d &, const Eigen::Vector4d &, dart::dynamics::BodyNode *, dart::dynamics::Marker::ConstraintType>((::boost::python::arg("name"), ::boost::python::arg("offset"), ::boost::python::arg("color"), ::boost::python::arg("bodyNode"), ::boost::python::arg("type"))))
.def("draw", static_cast<void (dart::dynamics::Marker::*)(dart::renderer::RenderInterface *, bool, const Eigen::Vector4d &, bool) const>(&dart::dynamics::Marker::draw), (::boost::python::arg("ri"), ::boost::python::arg("offset"), ::boost::python::arg("color"), ::boost::python::arg("useDefaultColor")))
