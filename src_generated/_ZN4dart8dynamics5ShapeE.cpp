...
.def("getBoundingBox", static_cast<const dart::math::BoundingBox &(dart::dynamics::Shape::*)() const>(&dart::dynamics::Shape::getBoundingBox), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
...
.def("draw", static_cast<void (dart::dynamics::Shape::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool) const>(&dart::dynamics::Shape::draw), (::boost::python::arg("_ri"), ::boost::python::arg("_color"), ::boost::python::arg("_useDefaultColor")))
.def("setHidden", static_cast<void (dart::dynamics::Shape::*)(bool)>(&dart::dynamics::Shape::setHidden), (::boost::python::arg("_hide")))
