...
.def("create", static_cast<dart::dynamics::SkeletonPtr (*)(const std::string &)>(&dart::dynamics::Skeleton::create), (::boost::python::arg("_name") = "Skeleton"))
...
.def("getConfiguration", static_cast<dart::dynamics::Skeleton::Configuration (dart::dynamics::Skeleton::*)(int) const>(&dart::dynamics::Skeleton::getConfiguration), (::boost::python::arg("flags")))
.def("getConfiguration", static_cast<dart::dynamics::Skeleton::Configuration (dart::dynamics::Skeleton::*)(const std::vector<std::size_t> &, int) const>(&dart::dynamics::Skeleton::getConfiguration), (::boost::python::arg("indices"), ::boost::python::arg("flags")))
...
.def("enableSelfCollision", static_cast<void (dart::dynamics::Skeleton::*)(bool)>(&dart::dynamics::Skeleton::enableSelfCollision), (::boost::python::arg("_enableAdjacentBodyCheck")))
...
.def("getRootBodyNode", static_cast<dart::dynamics::BodyNode *(dart::dynamics::Skeleton::*)(std::size_t)>(&dart::dynamics::Skeleton::getRootBodyNode), ::boost::python::return_value_policy<boost::python::return_by_smart_ptr<dart::dynamics::BodyNodePtr> >(), (::boost::python::arg("_treeIdx")))
...
.def("getIndexOf", static_cast<std::size_t (dart::dynamics::Skeleton::*)(const dart::dynamics::BodyNode *, bool) const>(&dart::dynamics::Skeleton::getIndexOf), (::boost::python::arg("_bn"), ::boost::python::arg("_warning")))
...
.def("getIndexOf", static_cast<std::size_t (dart::dynamics::Skeleton::*)(const dart::dynamics::Joint *, bool) const>(&dart::dynamics::Skeleton::getIndexOf), (::boost::python::arg("_joint"), ::boost::python::arg("_warning")))
...
.def("getIndexOf", static_cast<std::size_t (dart::dynamics::Skeleton::*)(const dart::dynamics::DegreeOfFreedom *, bool) const>(&dart::dynamics::Skeleton::getIndexOf), (::boost::python::arg("_dof"), ::boost::python::arg("_warning")))
...
.def("getIK", static_cast<const std::shared_ptr<dart::dynamics::WholeBodyIK> &(dart::dynamics::Skeleton::*)(bool)>(&dart::dynamics::Skeleton::getIK), ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("_createIfNull")))
...
.def("getSupportPolygon", static_cast<const dart::math::SupportPolygon &(dart::dynamics::Skeleton::*)() const>(&dart::dynamics::Skeleton::getSupportPolygon), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
.def("getSupportPolygon", static_cast<const dart::math::SupportPolygon &(dart::dynamics::Skeleton::*)(std::size_t) const>(&dart::dynamics::Skeleton::getSupportPolygon), ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("_treeIdx")))
...
.def("getSupportAxes", static_cast<const std::pair<Eigen::Vector3d, Eigen::Vector3d> &(dart::dynamics::Skeleton::*)() const>(&dart::dynamics::Skeleton::getSupportAxes), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
.def("getSupportAxes", static_cast<const std::pair<Eigen::Vector3d, Eigen::Vector3d> &(dart::dynamics::Skeleton::*)(std::size_t) const>(&dart::dynamics::Skeleton::getSupportAxes), ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("_treeIdx")))
...
.def("computeForwardKinematics", static_cast<void (dart::dynamics::Skeleton::*)(bool, bool, bool)>(&dart::dynamics::Skeleton::computeForwardKinematics), (::boost::python::arg("_updateTransforms"), ::boost::python::arg("_updateVels"), ::boost::python::arg("_updateAccs")))
.def("computeForwardDynamics", static_cast<void (dart::dynamics::Skeleton::*)()>(&dart::dynamics::Skeleton::computeForwardDynamics))
.def("computeInverseDynamics", static_cast<void (dart::dynamics::Skeleton::*)(bool, bool, bool)>(&dart::dynamics::Skeleton::computeInverseDynamics), (::boost::python::arg("_withExternalForces"), ::boost::python::arg("_withDampingForces"), ::boost::python::arg("_withSpringForces")))
...
.def("draw", static_cast<void (dart::dynamics::Skeleton::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool) const>(&dart::dynamics::Skeleton::draw), (::boost::python::arg("_ri"), ::boost::python::arg("_color"), ::boost::python::arg("_useDefaultColor")))
.def("drawMarkers", static_cast<void (dart::dynamics::Skeleton::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool) const>(&dart::dynamics::Skeleton::drawMarkers), (::boost::python::arg("_ri"), ::boost::python::arg("_color"), ::boost::python::arg("_useDefaultColor")))
