...
.def(::boost::python::init<float>((::boost::python::arg("_thickness"))))
.def(::boost::python::init<const Eigen::Vector3d &, const Eigen::Vector3d &, float>((::boost::python::arg("_v1"), ::boost::python::arg("_v2"), ::boost::python::arg("_thickness"))))
...
.def("getVertices", static_cast<const std::vector<Eigen::Vector3d> &(dart::dynamics::LineSegmentShape::*)() const>(&dart::dynamics::LineSegmentShape::getVertices), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
...
.def("getConnections", static_cast<const Eigen::aligned_vector<Eigen::Vector2i> &(dart::dynamics::LineSegmentShape::*)() const>(&dart::dynamics::LineSegmentShape::getConnections), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
