...
{
::boost::python::class_<dart::dynamics::Chain, ::boost::noncopyable, std::shared_ptr<dart::dynamics::Chain>, ::boost::python::bases<dart::dynamics::Linkage > >("Chain", boost::python::no_init)
