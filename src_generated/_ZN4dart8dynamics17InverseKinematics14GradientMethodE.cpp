...
.def("setComponentWiseClamp", static_cast<void (dart::dynamics::InverseKinematics::GradientMethod::*)(double)>(&dart::dynamics::InverseKinematics::GradientMethod::setComponentWiseClamp), (::boost::python::arg("_clamp") = 2.000000e-01))
