...
.def("draw", static_cast<void (dart::dynamics::EllipsoidShape::*)(dart::renderer::RenderInterface *, const Eigen::Vector4d &, bool) const>(&dart::dynamics::EllipsoidShape::draw), (::boost::python::arg("_ri"), ::boost::python::arg("_col"), ::boost::python::arg("_useDefaultColor") = true))
