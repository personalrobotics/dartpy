...
::boost::python::class_<dart::dynamics::TemplatedJacobianNode<dart::dynamics::BodyNode>, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::JacobianNode > >("EndEffectorBodyNode", boost::python::no_init)
