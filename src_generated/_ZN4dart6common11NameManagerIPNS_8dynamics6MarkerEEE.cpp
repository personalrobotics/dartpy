...
::boost::python::class_<dart::common::NameManager<dart::dynamics::Marker *> >("NameManagerMarker", boost::python::no_init)
...
.def("removeEntries", static_cast<void (dart::common::NameManager<dart::dynamics::Marker *>::*)(const std::string &, dart::dynamics::Marker *const &)>(&dart::common::NameManager<dart::dynamics::Marker *>::removeEntries), (::boost::python::arg("_name"), ::boost::python::arg("_obj")))
