...
.def(::boost::python::init<const Eigen::Vector3d &, const Eigen::Vector3d &, const dart::dynamics::ArrowShape::Properties &, const Eigen::Vector4d &, std::size_t>((::boost::python::arg("_tail"), ::boost::python::arg("_head"), ::boost::python::arg("_properties"), ::boost::python::arg("_color"), ::boost::python::arg("_resolution"))))
