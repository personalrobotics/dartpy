...
.def(::boost::python::init<const std::shared_ptr<dart::dynamics::HierarchicalIK> &, dart::constraint::BalanceConstraint::BalanceMethod_t, dart::constraint::BalanceConstraint::ErrorMethod_t>((::boost::python::arg("_ik"), ::boost::python::arg("_balanceMethod"), ::boost::python::arg("_errorMethod"))))
