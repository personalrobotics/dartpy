...
.def("getConnectedPointMass", static_cast<dart::dynamics::PointMass *(dart::dynamics::PointMass::*)(std::size_t)>(&dart::dynamics::PointMass::getConnectedPointMass), ::boost::python::return_value_policy<boost::python::reference_existing_object >(), (::boost::python::arg("_idx")))
...
.def("addExtForce", static_cast<void (dart::dynamics::PointMass::*)(const Eigen::Vector3d &, bool)>(&dart::dynamics::PointMass::addExtForce), (::boost::python::arg("_force"), ::boost::python::arg("_isForceLocal")))
.def("clearExtForce", static_cast<void (dart::dynamics::PointMass::*)()>(&dart::dynamics::PointMass::clearExtForce))
.def("setConstraintImpulse", static_cast<void (dart::dynamics::PointMass::*)(const Eigen::Vector3d &, bool)>(&dart::dynamics::PointMass::setConstraintImpulse), (::boost::python::arg("_constImp"), ::boost::python::arg("_isLocal")))
.def("addConstraintImpulse", static_cast<void (dart::dynamics::PointMass::*)(const Eigen::Vector3d &, bool)>(&dart::dynamics::PointMass::addConstraintImpulse), (::boost::python::arg("_constImp"), ::boost::python::arg("_isLocal")))
