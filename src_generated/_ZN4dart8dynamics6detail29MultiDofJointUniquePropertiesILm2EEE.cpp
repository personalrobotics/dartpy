...
::boost::python::class_<dart::dynamics::detail::MultiDofJointUniqueProperties<2> >("_ZN4dart8dynamics6detail29MultiDofJointUniquePropertiesILm2EEE", boost::python::no_init)
