...
{
::boost::python::class_<dart::dynamics::InverseKinematics, ::boost::noncopyable, ::boost::python::bases<dart::common::Subject > >("InverseKinematics", boost::python::no_init)
...
.def("getTarget", static_cast<std::shared_ptr<const dart::dynamics::SimpleFrame> (dart::dynamics::InverseKinematics::*)() const>(&dart::dynamics::InverseKinematics::getTarget))
