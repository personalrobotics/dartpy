...
.def("solve", static_cast<bool (dart::dynamics::InverseKinematics::*)(bool)>(&dart::dynamics::InverseKinematics::solve), (::boost::python::arg("_applySolution")))
.def("solve", static_cast<bool (dart::dynamics::InverseKinematics::*)(Eigen::VectorXd &, bool)>(&dart::dynamics::InverseKinematics::solve), (::boost::python::arg("positions"), ::boost::python::arg("_applySolution")))
...
.def("setActive", static_cast<void (dart::dynamics::InverseKinematics::*)(bool)>(&dart::dynamics::InverseKinematics::setActive), (::boost::python::arg("_active")))
...
.def("getDofMap", static_cast<const std::vector<int> &(dart::dynamics::InverseKinematics::*)() const>(&dart::dynamics::InverseKinematics::getDofMap), ::boost::python::return_value_policy<boost::python::copy_const_reference >())
...
.def("getErrorMethod", static_cast<dart::dynamics::InverseKinematics::ErrorMethod &(dart::dynamics::InverseKinematics::*)()>(&dart::dynamics::InverseKinematics::getErrorMethod), ::boost::python::return_value_policy<boost::python::reference_existing_object >())
.def("getGradientMethod", static_cast<dart::dynamics::InverseKinematics::GradientMethod &(dart::dynamics::InverseKinematics::*)()>(&dart::dynamics::InverseKinematics::getGradientMethod), ::boost::python::return_value_policy<boost::python::reference_existing_object >())
.def("getAnalytical", static_cast<dart::dynamics::InverseKinematics::Analytical *(dart::dynamics::InverseKinematics::*)()>(&dart::dynamics::InverseKinematics::getAnalytical), ::boost::python::return_value_policy<boost::python::reference_existing_object >())
...
.def("resetProblem", static_cast<void (dart::dynamics::InverseKinematics::*)(bool)>(&dart::dynamics::InverseKinematics::resetProblem), (::boost::python::arg("_clearSeeds")))
