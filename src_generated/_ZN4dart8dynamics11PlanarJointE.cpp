...
.def("setXYPlane", static_cast<void (dart::dynamics::PlanarJoint::*)(bool)>(&dart::dynamics::PlanarJoint::setXYPlane), (::boost::python::arg("_renameDofs")))
.def("setYZPlane", static_cast<void (dart::dynamics::PlanarJoint::*)(bool)>(&dart::dynamics::PlanarJoint::setYZPlane), (::boost::python::arg("_renameDofs")))
.def("setZXPlane", static_cast<void (dart::dynamics::PlanarJoint::*)(bool)>(&dart::dynamics::PlanarJoint::setZXPlane), (::boost::python::arg("_renameDofs")))
.def("setArbitraryPlane", static_cast<void (dart::dynamics::PlanarJoint::*)(const Eigen::Vector3d &, const Eigen::Vector3d &, bool)>(&dart::dynamics::PlanarJoint::setArbitraryPlane), (::boost::python::arg("_transAxis1"), ::boost::python::arg("_transAxis2"), ::boost::python::arg("_renameDofs")))
