...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::VisualAspectProperties>, ::boost::python::bases<dart::common::Aspect::Properties, dart::dynamics::detail::VisualAspectProperties > >("MakeCloneable_AspectProperties_VisualAspectProperties", boost::python::no_init)
