...
::boost::python::class_<dart::dynamics::SoftBodyNode, ::boost::noncopyable, dart::dynamics::SoftBodyNodePtr, ::boost::python::bases<dart::common::EmbedStateAndPropertiesOnTopOf<dart::dynamics::SoftBodyNode, dart::dynamics::detail::SoftBodyNodeUniqueState, dart::dynamics::detail::SoftBodyNodeUniqueProperties, dart::dynamics::BodyNode> > >("SoftBodyNode", boost::python::no_init)
