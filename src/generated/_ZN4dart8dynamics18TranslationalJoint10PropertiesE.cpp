...
.def("__init__", ::boost::python::make_constructor([](const dart::dynamics::MultiDofJoint<3>::Properties & _properties) -> dart::dynamics::TranslationalJoint::Properties * { return new dart::dynamics::TranslationalJoint::Properties(_properties); }, ::boost::python::default_call_policies(), (::boost::python::arg("_properties"))))
;
}
