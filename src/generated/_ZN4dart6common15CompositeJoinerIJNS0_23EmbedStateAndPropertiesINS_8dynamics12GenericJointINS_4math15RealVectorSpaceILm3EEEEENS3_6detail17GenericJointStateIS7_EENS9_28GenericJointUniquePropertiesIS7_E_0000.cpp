...
::boost::python::class_<dart::common::CompositeJoiner<dart::common::EmbedStateAndProperties<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<3> > >, dart::dynamics::Joint>, ::boost::noncopyable, ::boost::python::bases<dart::common::EmbedStateAndProperties<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<3> > >, dart::dynamics::Joint > >("_ZN4dart6common15CompositeJoinerIJNS0_23EmbedStateAndPropertiesINS_8dynamics12GenericJointINS_4math15RealVectorSpaceILm3EEEEENS3_6detail17GenericJointStateIS7_EENS9_28GenericJointUniquePropertiesIS7_EEEENS3_5JointEEEE", boost::python::no_init)
;
}
