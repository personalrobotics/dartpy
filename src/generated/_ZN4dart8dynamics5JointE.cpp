...
::boost::python::class_<dart::dynamics::Joint, ::boost::noncopyable, dart::dynamics::JointPtr, ::boost::python::bases<dart::common::EmbedProperties<dart::dynamics::Joint, dart::dynamics::detail::JointProperties>, dart::common::VersionCounter, dart::common::Subject > >("Joint", boost::python::no_init)
...
.def("setPositionLowerLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setPositionLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getPositionLowerLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getPositionLowerLimits(); })
...
.def("setPositionUpperLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & upperLimits) -> void { return self->setPositionUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getPositionUpperLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getPositionUpperLimits(); })
...
.def("setVelocityLowerLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setVelocityLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getVelocityLowerLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getVelocityLowerLimits(); })
...
.def("setVelocityUpperLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & upperLimits) -> void { return self->setVelocityUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getVelocityUpperLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getVelocityUpperLimits(); })
...
.def("setAccelerationLowerLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setAccelerationLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getAccelerationLowerLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getAccelerationLowerLimits(); })
...
.def("setAccelerationUpperLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & upperLimits) -> void { return self->setAccelerationUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getAccelerationUpperLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getAccelerationUpperLimits(); })
...
.def("getForce", [](const dart::dynamics::Joint *self, std::size_t _index) -> double { return self->getForce(_index); }, (::boost::python::arg("_index")))
...
.def("setForceLowerLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setForceLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getForceLowerLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getForceLowerLimits(); })
...
.def("setForceUpperLimits", [](dart::dynamics::Joint *self, const Eigen::VectorXd & upperLimits) -> void { return self->setForceUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getForceUpperLimits", [](const dart::dynamics::Joint *self) -> Eigen::VectorXd { return self->getForceUpperLimits(); })
