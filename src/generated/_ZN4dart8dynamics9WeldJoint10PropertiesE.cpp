...
::boost::python::class_<dart::dynamics::WeldJoint::Properties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::ZeroDofJoint::Properties > >("Properties", boost::python::no_init)
