...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<1> > >, ::boost::python::bases<dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<1> >, dart::common::Aspect::Properties > >("MakeCloneable_AspectProperties_R1JointUniqueProperties", boost::python::no_init)
