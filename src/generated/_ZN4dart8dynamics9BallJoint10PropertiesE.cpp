...
::boost::python::class_<dart::dynamics::BallJoint::Properties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::GenericJointProperties<dart::math::SO3Space> > >("Properties", boost::python::no_init)
