...
::boost::python::class_<dart::common::LocalResourceRetriever, std::shared_ptr<dart::common::LocalResourceRetriever>, ::boost::python::bases<dart::common::ResourceRetriever > >("LocalResourceRetriever", boost::python::no_init)
