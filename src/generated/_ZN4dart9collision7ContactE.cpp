...
.def("getNormalEpsilon", []() -> double { return dart::collision::Contact::getNormalEpsilon(); })
.def("getNormalEpsilonSquared", []() -> double { return dart::collision::Contact::getNormalEpsilonSquared(); })
.def("isZeroNormal", [](const Eigen::Vector3d & normal) -> bool { return dart::collision::Contact::isZeroNormal(normal); }, (::boost::python::arg("normal")))
.def("isNonZeroNormal", [](const Eigen::Vector3d & normal) -> bool { return dart::collision::Contact::isNonZeroNormal(normal); }, (::boost::python::arg("normal")))
.staticmethod("getNormalEpsilon")
.staticmethod("getNormalEpsilonSquared")
.staticmethod("isNonZeroNormal")
.staticmethod("isZeroNormal")
