...
::boost::python::class_<dart::dynamics::PrismaticJoint, ::boost::noncopyable, ::boost::python::bases<dart::common::EmbedPropertiesOnTopOf<dart::dynamics::PrismaticJoint, dart::dynamics::detail::PrismaticJointUniqueProperties, dart::dynamics::GenericJoint<dart::math::RealVectorSpace<1> > > > >("PrismaticJoint", boost::python::no_init)
