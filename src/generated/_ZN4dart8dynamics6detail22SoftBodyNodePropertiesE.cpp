...
::boost::python::class_<dart::dynamics::detail::SoftBodyNodeProperties, ::boost::python::bases<dart::dynamics::detail::SoftBodyNodeUniqueProperties > >("SoftBodyNodeProperties", boost::python::no_init)
