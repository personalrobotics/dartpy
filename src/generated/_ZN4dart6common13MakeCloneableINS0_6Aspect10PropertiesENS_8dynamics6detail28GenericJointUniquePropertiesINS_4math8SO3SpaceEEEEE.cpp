...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::SO3Space> >, ::boost::python::bases<dart::dynamics::detail::GenericJointUniqueProperties<dart::math::SO3Space>, dart::common::Aspect::Properties > >("MakeCloneable_AspectProperties_SO3JointUniqueProperties", boost::python::no_init)
