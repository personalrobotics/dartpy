...
::boost::python::class_<dart::constraint::SoftContactConstraint, ::boost::python::bases<dart::constraint::ConstraintBase > >("SoftContactConstraint", boost::python::no_init)
