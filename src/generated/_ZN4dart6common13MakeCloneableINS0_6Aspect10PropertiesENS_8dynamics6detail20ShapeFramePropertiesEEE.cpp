...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::ShapeFrameProperties>, ::boost::python::bases<dart::dynamics::detail::ShapeFrameProperties, dart::common::Aspect::Properties > >("MakeCloneable_AspectProperties_ShapeFrameProperties", boost::python::no_init)
