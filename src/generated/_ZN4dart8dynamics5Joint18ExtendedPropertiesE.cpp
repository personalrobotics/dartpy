...
::boost::python::class_<dart::dynamics::Joint::ExtendedProperties, ::boost::python::bases<dart::dynamics::detail::JointProperties > >("ExtendedProperties", boost::python::no_init)
