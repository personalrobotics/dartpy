...
::boost::python::class_<dart::dynamics::detail::PrismaticJointProperties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<1> >, dart::dynamics::detail::PrismaticJointUniqueProperties > >("PrismaticJointProperties", boost::python::no_init)
