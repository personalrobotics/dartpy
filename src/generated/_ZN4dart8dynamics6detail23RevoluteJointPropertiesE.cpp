...
::boost::python::class_<dart::dynamics::detail::RevoluteJointProperties, ::boost::python::bases<dart::dynamics::detail::RevoluteJointUniqueProperties, dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<1> > > >("RevoluteJointProperties", boost::python::no_init)
