...
::boost::python::class_<dart::dynamics::detail::ScrewJointProperties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::ScrewJointUniqueProperties, dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<1> > > >("ScrewJointProperties", boost::python::no_init)
