...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::State, dart::dynamics::detail::GenericJointState<dart::math::SO3Space> >, ::boost::python::bases<dart::dynamics::detail::GenericJointState<dart::math::SO3Space>, dart::common::Aspect::State > >("MakeCloneable_AspectState_SO3JointState", boost::python::no_init)
