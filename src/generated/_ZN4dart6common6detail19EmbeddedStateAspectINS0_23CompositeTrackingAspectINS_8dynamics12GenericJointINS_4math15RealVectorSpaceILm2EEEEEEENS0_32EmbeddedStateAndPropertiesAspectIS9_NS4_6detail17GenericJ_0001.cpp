...
{
::boost::python::object parent_object(::boost::python::scope().attr("common").attr("detail").attr("_ZN4dart6common6detail19EmbeddedStateAspectINS0_23CompositeTrackingAspectINS_8dynamics12GenericJointINS_4math15RealVectorSpaceILm2EEEEEEENS0_32EmbeddedStateAndPropertiesAspectIS9_NS4_6detail17GenericJointStateIS8_EENSC_28GenericJointUniquePropertiesIS8_EEEESE_NS0_13MakeCloneableINS0_6Aspect5StateESE_EEXadL_ZNS1_23DefaultSetEmbeddedStateISH_SL_EEvPT_RKT0_EEXadL_ZNS1_23DefaultGetEmbeddedStateISH_SL_EESR_PKSN_EEEE"));
::boost::python::scope parent_scope(parent_object);

::boost::python::enum_<dart::common::detail::EmbeddedStateAspect<dart::common::CompositeTrackingAspect<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<2> > >, dart::common::EmbeddedStateAndPropertiesAspect<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<2> >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<2> >, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<2> > >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<2> >, dart::common::MakeCloneable<dart::common::Aspect::State, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<2> > >, &dart::common::detail::DefaultSetEmbeddedState, &dart::common::detail::DefaultGetEmbeddedState>::DelegateTag>("DelegateTag")
.value("Delegate", dart::common::detail::EmbeddedStateAspect<dart::common::CompositeTrackingAspect<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<2> > >, dart::common::EmbeddedStateAndPropertiesAspect<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<2> >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<2> >, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<2> > >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<2> >, dart::common::MakeCloneable<dart::common::Aspect::State, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<2> > >, &dart::common::detail::DefaultSetEmbeddedState, &dart::common::detail::DefaultGetEmbeddedState>::DelegateTag::Delegate)
;
}
