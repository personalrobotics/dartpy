...
::boost::python::class_<dart::dynamics::BodyNodeSpecializedFor<dart::dynamics::ShapeNode>, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::BasicNodeManagerForBodyNode > >("BodyNodeSpecializedForShapeNode", boost::python::no_init)
