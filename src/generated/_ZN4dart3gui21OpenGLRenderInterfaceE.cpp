...
::boost::python::class_<dart::gui::OpenGLRenderInterface, ::boost::python::bases<dart::gui::RenderInterface > >("OpenGLRenderInterface", boost::python::no_init)
...
.def("drawLineSegments", [](dart::gui::OpenGLRenderInterface *self, const std::vector<Eigen::Vector3d> & _vertices, const Eigen::aligned_vector<Eigen::Vector2i> & _connections) -> void { return self->drawLineSegments(_vertices, _connections); }, (::boost::python::arg("_vertices"), ::boost::python::arg("_connections")))
