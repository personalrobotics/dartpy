...
::boost::python::class_<dart::dynamics::detail::UniversalJointProperties, ::boost::python::bases<dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<2> >, dart::dynamics::detail::UniversalJointUniqueProperties > >("UniversalJointProperties", boost::python::no_init)
