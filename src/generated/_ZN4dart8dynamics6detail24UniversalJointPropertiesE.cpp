...
::boost::python::class_<dart::dynamics::detail::UniversalJointProperties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::UniversalJointUniqueProperties, dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<2> > > >("UniversalJointProperties", boost::python::no_init)
