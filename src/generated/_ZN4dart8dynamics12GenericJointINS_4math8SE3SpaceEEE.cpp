...
.def("setDofName", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, const std::string & name) -> const std::string & { return self->setDofName(index, name); }, ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("index"), ::boost::python::arg("name")))
.def("setDofName", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, const std::string & name, bool preserveName) -> const std::string & { return self->setDofName(index, name, preserveName); }, ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("index"), ::boost::python::arg("name"), ::boost::python::arg("preserveName")))
.def("preserveDofName", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, bool preserve) -> void { return self->preserveDofName(index, preserve); }, (::boost::python::arg("index"), ::boost::python::arg("preserve")))
.def("isDofNamePreserved", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index) -> bool { return self->isDofNamePreserved(index); }, (::boost::python::arg("index")))
.def("getDofName", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index) -> const std::string & { return self->getDofName(index); }, ::boost::python::return_value_policy<boost::python::copy_const_reference >(), (::boost::python::arg("index")))
.def("getIndexInSkeleton", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index) -> size_t { return self->getIndexInSkeleton(index); }, (::boost::python::arg("index")))
.def("getIndexInTree", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index) -> size_t { return self->getIndexInTree(index); }, (::boost::python::arg("index")))
...
.def("setPositionLowerLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double position) -> void { return self->setPositionLowerLimit(index, position); }, (::boost::python::arg("index"), ::boost::python::arg("position")))
...
.def("setPositionUpperLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double position) -> void { return self->setPositionUpperLimit(index, position); }, (::boost::python::arg("index"), ::boost::python::arg("position")))
...
.def("setInitialPosition", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double initial) -> void { return self->setInitialPosition(index, initial); }, (::boost::python::arg("index"), ::boost::python::arg("initial")))
...
.def("setVelocityLowerLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double velocity) -> void { return self->setVelocityLowerLimit(index, velocity); }, (::boost::python::arg("index"), ::boost::python::arg("velocity")))
...
.def("setVelocityUpperLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double velocity) -> void { return self->setVelocityUpperLimit(index, velocity); }, (::boost::python::arg("index"), ::boost::python::arg("velocity")))
...
.def("setInitialVelocity", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double initial) -> void { return self->setInitialVelocity(index, initial); }, (::boost::python::arg("index"), ::boost::python::arg("initial")))
...
.def("setAccelerationLowerLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double acceleration) -> void { return self->setAccelerationLowerLimit(index, acceleration); }, (::boost::python::arg("index"), ::boost::python::arg("acceleration")))
...
.def("setAccelerationUpperLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double acceleration) -> void { return self->setAccelerationUpperLimit(index, acceleration); }, (::boost::python::arg("index"), ::boost::python::arg("acceleration")))
...
.def("setForceLowerLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double force) -> void { return self->setForceLowerLimit(index, force); }, (::boost::python::arg("index"), ::boost::python::arg("force")))
...
.def("setForceUpperLimit", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double force) -> void { return self->setForceUpperLimit(index, force); }, (::boost::python::arg("index"), ::boost::python::arg("force")))
.def("getForceUpperLimit", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index) -> double { return self->getForceUpperLimit(index); }, (::boost::python::arg("index")))
...
.def("setSpringStiffness", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double k) -> void { return self->setSpringStiffness(index, k); }, (::boost::python::arg("index"), ::boost::python::arg("k")))
...
.def("setRestPosition", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double q0) -> void { return self->setRestPosition(index, q0); }, (::boost::python::arg("index"), ::boost::python::arg("q0")))
...
.def("setDampingCoefficient", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double d) -> void { return self->setDampingCoefficient(index, d); }, (::boost::python::arg("index"), ::boost::python::arg("d")))
...
.def("setCoulombFriction", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, size_t index, double friction) -> void { return self->setCoulombFriction(index, friction); }, (::boost::python::arg("index"), ::boost::python::arg("friction")))
...
.def("getRelativeJacobian", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & _positions) -> dart::math::Jacobian { return self->getRelativeJacobian(_positions); }, (::boost::python::arg("_positions")))
