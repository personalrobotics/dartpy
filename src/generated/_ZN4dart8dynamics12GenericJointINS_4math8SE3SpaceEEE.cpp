...
::boost::python::class_<dart::dynamics::GenericJoint<dart::math::SE3Space>, ::boost::noncopyable, ::boost::python::bases<dart::common::EmbedStateAndPropertiesOnTopOf<dart::dynamics::GenericJoint<dart::math::SE3Space>, dart::dynamics::detail::GenericJointState<dart::math::SE3Space>, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::SE3Space>, dart::dynamics::Joint> > >("SE3Joint", boost::python::no_init)
...
.def("setPositionLowerLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setPositionLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getPositionLowerLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getPositionLowerLimits(); })
...
.def("setPositionUpperLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & upperLimits) -> void { return self->setPositionUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getPositionUpperLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getPositionUpperLimits(); })
...
.def("setVelocityLowerLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setVelocityLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getVelocityLowerLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getVelocityLowerLimits(); })
...
.def("setVelocityUpperLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & upperLimits) -> void { return self->setVelocityUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getVelocityUpperLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getVelocityUpperLimits(); })
...
.def("setAccelerationLowerLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setAccelerationLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getAccelerationLowerLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getAccelerationLowerLimits(); })
...
.def("setAccelerationUpperLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & upperLimits) -> void { return self->setAccelerationUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getAccelerationUpperLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getAccelerationUpperLimits(); })
...
.def("getForce", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self, std::size_t index) -> double { return self->getForce(index); }, (::boost::python::arg("index")))
...
.def("setForceLowerLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & lowerLimits) -> void { return self->setForceLowerLimits(lowerLimits); }, (::boost::python::arg("lowerLimits")))
.def("getForceLowerLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getForceLowerLimits(); })
...
.def("setForceUpperLimits", [](dart::dynamics::GenericJoint<dart::math::SE3Space> *self, const Eigen::VectorXd & upperLimits) -> void { return self->setForceUpperLimits(upperLimits); }, (::boost::python::arg("upperLimits")))
.def("getForceUpperLimits", [](const dart::dynamics::GenericJoint<dart::math::SE3Space> *self) -> Eigen::VectorXd { return self->getForceUpperLimits(); })
