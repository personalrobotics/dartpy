...
.def("drawLineSegments", [](dart::gui::RenderInterface *self, const std::vector<Eigen::Vector3d> & _vertices, const dart::common::aligned_vector<Eigen::Vector2i> & _connections) -> void { return self->drawLineSegments(_vertices, _connections); }, (::boost::python::arg("_vertices"), ::boost::python::arg("_connections")))
