...
::boost::python::class_<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<3> >, ::boost::noncopyable, ::boost::python::bases<dart::common::EmbedStateAndPropertiesOnTopOf<dart::dynamics::GenericJoint<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::GenericJointState<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::GenericJointUniqueProperties<dart::math::RealVectorSpace<3> >, dart::dynamics::Joint> > >("R3Joint", boost::python::no_init)
