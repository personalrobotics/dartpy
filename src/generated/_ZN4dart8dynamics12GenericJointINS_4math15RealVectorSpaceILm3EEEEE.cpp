...
.def("getRelativeJacobian", [](const dart::dynamics::GenericJoint<dart::math::RealVectorSpace<3> > *self, const Eigen::VectorXd & positions) -> dart::math::Jacobian { return self->getRelativeJacobian(positions); }, (::boost::python::arg("positions")))
