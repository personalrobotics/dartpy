...
::boost::python::class_<dart::dynamics::EndEffector, ::boost::noncopyable, dart::dynamics::TemplateNodePtr<dart::dynamics::EndEffector, dart::dynamics::BodyNode>, ::boost::python::bases<dart::common::EmbedPropertiesOnTopOf<dart::dynamics::EndEffector, dart::dynamics::detail::EndEffectorProperties, dart::dynamics::CompositeNode<dart::common::CompositeJoiner<dart::dynamics::FixedJacobianNode, dart::common::SpecializedForAspect<dart::dynamics::Support> > > > > >("EndEffector", boost::python::no_init)
