...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::TranslationalJoint2DUniqueProperties>, ::boost::python::bases<dart::common::Aspect::Properties, dart::dynamics::detail::TranslationalJoint2DUniqueProperties > >("MakeCloneable_AspectProperties_TranslationalJoint2DUniqueProperties", boost::python::no_init)
