...
::boost::python::def("make_unique", [](const dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::JointProperties> & _arg0_) -> std::unique_ptr<dart::common::EmbeddedPropertiesAspect<dart::dynamics::Joint, dart::dynamics::detail::JointProperties> > { return dart::common::make_unique<dart::common::EmbeddedPropertiesAspect<dart::dynamics::Joint, dart::dynamics::detail::JointProperties>, const dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::JointProperties> &>(_arg0_); }, (::boost::python::arg("_arg0_")));
