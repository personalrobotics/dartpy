...
::boost::python::def("make_unique", [](const dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::CollisionAspectProperties> & _arg0_) -> std::unique_ptr<dart::dynamics::CollisionAspect> { return dart::common::make_unique<dart::dynamics::CollisionAspect, const dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::CollisionAspectProperties> &>(_arg0_); }, (::boost::python::arg("_arg0_")));
