...
::boost::python::class_<dart::constraint::BalanceConstraint, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::HierarchicalIK::Function, dart::optimizer::Function > >("BalanceConstraint", boost::python::no_init)
