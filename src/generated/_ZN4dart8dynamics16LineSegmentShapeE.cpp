...
.def("getConnections", [](const dart::dynamics::LineSegmentShape *self) -> const Eigen::aligned_vector<Eigen::Vector2i> & { return self->getConnections(); }, ::boost::python::return_value_policy<boost::python::copy_const_reference >())
