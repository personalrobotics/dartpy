...
::boost::python::class_<dart::common::MakeCloneable<dart::common::Aspect::Properties, dart::dynamics::detail::EntityNodeProperties>, ::boost::python::bases<dart::dynamics::detail::EntityNodeProperties, dart::common::Aspect::Properties > >("MakeCloneable_AspectProperties_EntityNodeProperties", boost::python::no_init)
