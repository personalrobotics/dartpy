...
::boost::python::class_<dart::utils::FileInfoC3D >("FileInfoC3D", boost::python::no_init)
...
.def("addData", [](dart::utils::FileInfoC3D *self, const Eigen::EIGEN_V_VEC3D & _data) -> void { return self->addData(_data); }, (::boost::python::arg("_data")))
