...
::boost::python::class_<dart::dynamics::detail::PlanarJointProperties, ::boost::python::bases<dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::PlanarJointUniqueProperties > >("PlanarJointProperties", boost::python::no_init)
