...
.def("setPositionUpperLimit", [](dart::dynamics::ZeroDofJoint *self, std::size_t _index, double _position) -> void { return self->setPositionUpperLimit(_index, _position); }, (::boost::python::arg("_index"), ::boost::python::arg("_position")))
.def("getPositionUpperLimit", [](const dart::dynamics::ZeroDofJoint *self, std::size_t _index) -> double { return self->getPositionUpperLimit(_index); }, (::boost::python::arg("_index")))
...
.def("getForce", [](dart::dynamics::ZeroDofJoint *self, std::size_t _index) -> double { return self->getForce(_index); }, (::boost::python::arg("_index")))
