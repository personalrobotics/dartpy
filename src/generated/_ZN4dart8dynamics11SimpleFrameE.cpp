...
::boost::python::class_<dart::dynamics::SimpleFrame, std::shared_ptr<dart::dynamics::SimpleFrame>, ::boost::python::bases<dart::dynamics::ShapeFrame, dart::dynamics::Detachable > >("SimpleFrame", boost::python::no_init)
