...
::boost::python::class_<dart::dynamics::BodyNodeSpecializedFor<dart::dynamics::EndEffector>, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::BasicNodeManagerForBodyNode > >("BodyNodeSpecializedForEndEffector", boost::python::no_init)
