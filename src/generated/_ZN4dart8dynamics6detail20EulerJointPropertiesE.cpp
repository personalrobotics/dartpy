...
::boost::python::class_<dart::dynamics::detail::EulerJointProperties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::EulerJointUniqueProperties, dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<3> > > >("EulerJointProperties", boost::python::no_init)
