...
::boost::python::class_<dart::dynamics::detail::EulerJointProperties, ::boost::noncopyable, ::boost::python::bases<dart::dynamics::detail::GenericJointProperties<dart::math::RealVectorSpace<3> >, dart::dynamics::detail::EulerJointUniqueProperties > >("EulerJointProperties", boost::python::no_init)
